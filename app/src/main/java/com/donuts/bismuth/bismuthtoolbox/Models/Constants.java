...
public class Constants {
    ...
    public static final String BIS_PRICE_URL = "https://api.coingecko.com/api/v3/simple/price?ids=bismuth&vs_currencies=usd,btc"; // BIS price from coingecko
    ...
    public static final List<String> MAIN_SCREEN_URLS = new ArrayList<>(Arrays.asList(BIS_PRICE_URL, BIS_HN_BASIC_URL));
